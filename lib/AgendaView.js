  ...
  _createClass(AgendaView, [{
    ...
    value: function render() {
      ...
      var resourceEventsList = renderData.map(function (item) {
        return _react2.default.createElement(_AgendaResourceEvents2.default, _extends({}, _this2.props, { resourceEvents: item, key: item.slotId }));
      });
      ...
      return _react2.default.createElement('tr', null, _react2.default.createElement('td', null, _react2.default.createElement('table', { className: 'scheduler-table' }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', { style: { height: tableHeaderHeight } }, _react2.default.createElement('th', { style: { width: agendaResourceTableWidth }, className: 'header3-text' }, resourceName), _react2.default.createElement('th', { className: 'header3-text' }, agendaViewHeader))), _react2.default.createElement('tbody', null, resourceEventsList))));
    }
  }]);
