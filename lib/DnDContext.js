    ...
    return {
      drop: function drop(props, monitor, component) {
        ...
        if (type === _DnDTypes.DnDTypes.EVENT) {
          ...
          if (cellUnit !== _index.CellUnits.Hour) {
            initialEndTime = localeMoment(resourceEvents.headerItems[initialLeftIndex].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
          }
        }
        ...
        if (cellUnit !== _index.CellUnits.Hour) {
          endTime = localeMoment(resourceEvents.headerItems[leftIndex].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
        }
      ...
      hover: function hover(props, monitor, component) {
        ...
        if (type === _DnDTypes.DnDTypes.EVENT) {
          ...
          if (cellUnit !== _index.CellUnits.Hour) {
            initialEnd = localeMoment(resourceEvents.headerItems[initialLeftIndex].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
          }
        }
        var point = monitor.getClientOffset();
        var leftIndex = Math.floor((point.x - pos.x) / cellWidth);
        ...
        if (cellUnit !== _index.CellUnits.Hour) {
          newEnd = localeMoment(resourceEvents.headerItems[leftIndex].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
        }
