      ...
      var tableRows = displayRenderData.map(function (item) {
        var rowCells = headers.map(function (header, index) {
          ...
          if (new Date(header.time).toLocaleDateString() === new Date().toLocaleDateString()) {
            style = _extends({}, style, { backgroundColor: config.todayBodyColor });
          }
          ...
          return _react2.default.createElement('td', { key: key, style: style }, _react2.default.createElement('div', null));
        });
