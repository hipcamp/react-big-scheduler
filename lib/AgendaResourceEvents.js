...
var AgendaResourceEvents = (_temp = _class = function (_Component) {
  ...
  _createClass(AgendaResourceEvents, [{
    ...
    value: function render() {
      ...
      var a = slotClickedFunc != undefined ? _react2.default.createElement('a', {
        onClick: function onClick() {
          slotClickedFunc(schedulerData, resourceEvents);
        }
      }, resourceEvents.slotName) : _react2.default.createElement('span', null, resourceEvents.slotName);
      ...
      return _react2.default.createElement('tr', { style: { minHeight: config.eventItemLineHeight + 2 } }, _react2.default.createElement('td', { 'data-resource-id': resourceEvents.slotId }, slotItem), _react2.default.createElement('td', null, _react2.default.createElement('div', { className: 'day-event-container' }, events)));
    }
  }]);
