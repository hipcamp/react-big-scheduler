...
var AgendaEventItem = (_temp = _class = function (_Component) {
  ...
  _createClass(AgendaEventItem, [{
    ...
    value: function render() {
      ...
      }, _react2.default.createElement('span', { style: { marginLeft: '10px', lineHeight: config.eventItemHeight + 'px' } }, titleText));
      ...
      return config.eventItemPopoverEnabled ? _react2.default.createElement(_popover2.default, { placement: 'bottomLeft', content: content, trigger: 'hover' }, _react2.default.createElement('a', {
        className: 'day-event',
      ...
      }, eventItemTemplate)) : _react2.default.createElement('span', null, _react2.default.createElement('a', {
        className: 'day-event',
        onClick: function onClick() {
          if (!!eventItemClick) {
            eventItemClick(schedulerData, eventItem);
