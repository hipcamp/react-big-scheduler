    ...
    value: function render() {
      ...
      if (cellUnit === _index.CellUnits.Hour) {
        headers.forEach(function (item, index) {
          if (index % minuteStepsInHour === 0) {
            ...
            if (typeof nonAgendaCellHeaderTemplateResolver === 'function') {
              ...
              element = _react2.default.createElement('th', { key: item.time, className: 'header3-text', style: style }, _react2.default.createElement('div', null, pList));
            }
        ...
        headerList = headers.map(function (item, index) {
          ...
          return _react2.default.createElement('th', { key: item.time, className: "header3-text", style: style }, _react2.default.createElement('div', null, pList));
        });
      }

      return _react2.default.createElement('thead', null, _react2.default.createElement('tr', { style: { height: headerHeight } }, headerList));
    }
  }]);
