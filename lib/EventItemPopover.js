      ...
      if (eventItemPopoverTemplateResolver != undefined) {
        ...
        if (subtitleGetter !== undefined) {
          ...
          if (subtitle != undefined) {
            subtitleRow = _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle' }, _react2.default.createElement(_col3.default, { span: 2 }, _react2.default.createElement('div', null)), _react2.default.createElement(_col3.default, { span: 22, className: 'overflow-text' }, _react2.default.createElement('span', { className: 'header2-text', title: subtitle }, subtitle)));
          }
        }
        ...
        if (viewEventText !== undefined && viewEventClick !== undefined && (eventItem.clickable1 == undefined || eventItem.clickable1)) {
          var col = _react2.default.createElement(_col3.default, { span: 22 }, _react2.default.createElement('span', {
          ...
          if (viewEvent2Text !== undefined && viewEvent2Click !== undefined && (eventItem.clickable2 == undefined || eventItem.clickable2)) {
            col = _react2.default.createElement(_col3.default, { span: 22 }, _react2.default.createElement('span', {
              className: 'header2-text',
              style: { color: '#108EE9', cursor: 'pointer' },
              onClick: function onClick() {
                viewEventClick(schedulerData, eventItem);
              }
            }, viewEventText), _react2.default.createElement('span', {
              className: 'header2-text',
          ...
          opsRow = _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle' }, _react2.default.createElement(_col3.default, { span: 2 }, _react2.default.createElement('div', null)), col);
        } else if (viewEvent2Text !== undefined && viewEvent2Click !== undefined && (eventItem.clickable2 == undefined || eventItem.clickable2)) {
          var _col = _react2.default.createElement(_col3.default, { span: 22 }, _react2.default.createElement('span', {
            className: 'header2-text',
            style: { color: '#108EE9', cursor: 'pointer' },
            onClick: function onClick() {
              viewEvent2Click(schedulerData, eventItem);
          ...
          opsRow = _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle' }, _react2.default.createElement(_col3.default, { span: 2 }, _react2.default.createElement('div', null)), _col);
        }

        var dateFormat = config.eventItemPopoverDateFormat;
        return _react2.default.createElement('div', { style: { width: '300px' } }, _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle' }, _react2.default.createElement(_col3.default, { span: 2 }, _react2.default.createElement('div', { className: 'status-dot', style: { backgroundColor: statusColor } })), _react2.default.createElement(_col3.default, { span: 22, className: 'overflow-text' }, _react2.default.createElement('span', { className: 'header2-text', title: title }, title))), subtitleRow, _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle' }, _react2.default.createElement(_col3.default, { span: 2 }, _react2.default.createElement('div', null)), _react2.default.createElement(_col3.default, { span: 22 }, _react2.default.createElement('span', { className: 'header1-text' }, start.format('HH:mm')), _react2.default.createElement('span', { className: 'help-text', style: { marginLeft: '8px' } }, start.format(dateFormat)), _react2.default.createElement('span', { className: 'header2-text', style: { marginLeft: '8px' } }, '-'), _react2.default.createElement('span', { className: 'header1-text', style: { marginLeft: '8px' } }, end.format('HH:mm')), _react2.default.createElement('span', { className: 'help-text', style: { marginLeft: '8px' } }, end.format(dateFormat)))), opsRow);
      }
    }
  }]);
