...
var Scheduler = (_temp = _class = function (_Component) {
  ...
  _createClass(Scheduler, [{
    ...
    value: function render() {
      ...
      var radioButtonList = config.views.map(function (item) {
        ...
        }, _react2.default.createElement('span', { style: { margin: '0px 8px' } }, item.viewName));
      });
      ...
      if (showAgenda) {
        ...
        tbodyContent = _react2.default.createElement('tr', null, _react2.default.createElement('td', { style: { width: resourceTableWidth, verticalAlign: 'top' } }, _react2.default.createElement('div', { className: 'resource-view' }, _react2.default.createElement('div', {
        ...
        }, _react2.default.createElement('table', { className: 'resource-table' }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', { style: { height: config.tableHeaderHeight } }, _react2.default.createElement('th', { className: 'header3-text' }, resourceName)))))), _react2.default.createElement('div', {
        ...
        }, _react2.default.createElement(_ResourceView2.default, _extends({}, this.props, { contentScrollbarHeight: resourcePaddingBottom }))))), _react2.default.createElement('td', null, _react2.default.createElement('div', {
        ...
        }, _react2.default.createElement('table', { className: 'scheduler-bg-table' }, _react2.default.createElement(_HeaderView2.default, this.props))))), _react2.default.createElement('div', {
        ...
        }, _react2.default.createElement('div', { style: { width: schedulerWidth, height: contentHeight } }, _react2.default.createElement('div', { className: 'scheduler-content' }, _react2.default.createElement('table', { className: 'scheduler-content-table' }, _react2.default.createElement('tbody', null, resourceEventsList))), _react2.default.createElement('div', { className: 'scheduler-bg' }, _react2.default.createElement('table', {
      ...
      var popover = _react2.default.createElement('div', { className: 'popover-calendar' }, _react2.default.createElement(_calendar2.default, { fullscreen: false, onSelect: this.onSelect }));
      var schedulerHeader = _react2.default.createElement('div', null);
      if (config.headerEnabled) {
        schedulerHeader = _react2.default.createElement(_row2.default, { type: 'flex', align: 'middle', justify: 'space-between', style: { marginBottom: '24px' } }, leftCustomHeader, _react2.default.createElement(_col2.default, null, _react2.default.createElement('div', { className: 'header2-text' }, _react2.default.createElement(_icon2.default, {
          type: 'left',
        ...
        }, _react2.default.createElement('span', { className: 'header2-text-label', style: { cursor: 'pointer' } }, dateLabel)) : _react2.default.createElement('span', { className: 'header2-text-label' }, dateLabel), _react2.default.createElement(_icon2.default, {
          type: 'right',
          style: { marginLeft: '8px' },
          className: 'icon-nav',
          onClick: this.goNext
        }))), _react2.default.createElement(_col2.default, null, _react2.default.createElement(RadioGroup, { defaultValue: defaultValue, size: 'default', onChange: this.onViewChange }, radioButtonList)), rightCustomHeader);
      }

      return _react2.default.createElement('table', { id: 'RBS-Scheduler-root', className: 'scheduler', style: { width: width + 'px' } }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, _react2.default.createElement('td', { colSpan: '2' }, schedulerHeader))), _react2.default.createElement('tbody', null, tbodyContent));
    }
  }]);
  ...
  this.onSchedulerHeadScroll = function (proxy, event) {
    if ((_this3.currentArea === 2 || _this3.currentArea === -1) && _this3.schedulerContent.scrollLeft != _this3.schedulerHead.scrollLeft) {
  ...
  this.onSchedulerResourceScroll = function (proxy, event) {
    if ((_this3.currentArea === 1 || _this3.currentArea === -1) && _this3.schedulerContent.scrollTop != _this3.schedulerResource.scrollTop) {
  ...
  this.onSchedulerContentScroll = function (proxy, event) {
    if (_this3.currentArea === 0 || _this3.currentArea === -1) {
      if (_this3.schedulerHead.scrollLeft != _this3.schedulerContent.scrollLeft) {
        _this3.schedulerHead.scrollLeft = _this3.schedulerContent.scrollLeft;
      }
      if (_this3.schedulerResource.scrollTop != _this3.schedulerContent.scrollTop) {
        _this3.schedulerResource.scrollTop = _this3.schedulerContent.scrollTop;
      }
    }
