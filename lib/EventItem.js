  ...
  _createClass(EventItem, [{
    ...
    value: function render() {
      ...
      if (this.endResizable(this.props)) {
        endResizeDiv = _react2.default.createElement('div', { className: 'event-resizer event-end-resizer', ref: function ref(_ref2) {
      ...
      }, _react2.default.createElement('span', { style: { marginLeft: '10px', lineHeight: config.eventItemHeight + 'px' } }, eventTitle));
    ...
    if (_this3.startResizer != undefined) {
      if (supportTouch) {
        ...
        if (_this3.startResizable(props)) {
          _this3.startResizer.addEventListener('mousedown', _this3.initStartDrag, false);
        }
      }
    }
    if (_this3.endResizer != undefined) {
      if (supportTouch) {
        ...
        if (_this3.endResizable(props)) {
          _this3.endResizer.addEventListener('mousedown', _this3.initEndDrag, false);
        }
      }
    }
  };
