...
var ResourceEvents = (_temp = _class = function (_Component) {
  ...
  function ResourceEvents(props) {
    ...
    _this.stopDrag = function (ev) {
      ...
      if (cellUnit !== _index.CellUnits.Hour) {
        endTime = localeMoment(resourceEvents.headerItems[rightIndex - 1].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
      }
  ...
  _createClass(ResourceEvents, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('tr', null, _react2.default.createElement('td', { style: { width: rowWidth } }, connectDropTarget(_react2.default.createElement('div', {
