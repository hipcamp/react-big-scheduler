...
var Summary = (_temp = _class = function (_Component) {
  ...
  _createClass(Summary, [{
    ...
    value: function render() {
      ...
      if (config.summaryPos === _index.SummaryPos.TopRight || config.summaryPos === _index.SummaryPos.BottomRight) {
        textAlign = 'right';
      } else if (config.summaryPos === _index.SummaryPos.TopLeft || config.summaryPos === _index.SummaryPos.BottomLeft) {
        textAlign = 'left';
      }
      var style = {
      ...
      }, _react2.default.createElement('div', { style: style }, summary.text));
    }
  }]);
